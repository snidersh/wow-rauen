...
function miUI_CheckButtonOnClick()
	...
	if ( name == "miUI_CheckShowCursor" ) then
		if ( checked ) then
			...
			MapInfo_Config.ShowCursor = false;
		end
	end
	
	if ( name == "miUI_CheckShowPlayer" ) then
		if ( checked ) then
			MapInfo_Config.ShowPlayer = true;
		else
